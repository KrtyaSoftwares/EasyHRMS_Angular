...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_services_common_lookup_data_service__ = __webpack_require__(439);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_selfservice_component__ = __webpack_require__(520);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_holiday_details_holiday_details_component__ = __webpack_require__(519);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_changepassword_changepassword_component__ = __webpack_require__(518);
...
var routes = [
    {
        ...
        children: [
            { path: 'myprofile', loadChildren: function () { return new Promise(function (resolve) { __webpack_require__.e/* require.ensure */(28).then((function (require) { resolve(__webpack_require__(582)['MyprofileModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); } },
            { path: 'mysalary', loadChildren: function () { return new Promise(function (resolve) { __webpack_require__.e/* require.ensure */(27).then((function (require) { resolve(__webpack_require__(584)['MysalaryModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); } },
            { path: 'myleaves', loadChildren: function () { return new Promise(function (resolve) { __webpack_require__.e/* require.ensure */(13).then((function (require) { resolve(__webpack_require__(580)['MyleavesModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); } },
            { path: 'myadvancesclaim', loadChildren: function () { return new Promise(function (resolve) { __webpack_require__.e/* require.ensure */(30).then((function (require) { resolve(__webpack_require__(575)['MyadvancesclaimModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); } },
            { path: 'myattendance', loadChildren: function () { return new Promise(function (resolve) { __webpack_require__.e/* require.ensure */(29).then((function (require) { resolve(__webpack_require__(577)['MyattendanceModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); } },
        ]
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_holiday_details_holiday_details_component__ = __webpack_require__(519);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_changepassword_changepassword_component__ = __webpack_require__(518);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selfservice_routing_module__ = __webpack_require__(585);
